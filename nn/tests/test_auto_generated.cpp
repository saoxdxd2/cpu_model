...
int main() {
    ...
    nca::testing::run_benchmark("nca::execution::multimodal_fused_step", &nca::execution::multimodal_fused_step);
    nca::testing::run_benchmark("nca::execution::shuffle_active_tokens", &nca::execution::shuffle_active_tokens);
